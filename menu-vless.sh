...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/wget https://raw.githubusercontent.com/sikivpn/v4/main/update.sh && chmod +x update.sh && ./update.sh/permission/main/ipmini > /root/tmp
